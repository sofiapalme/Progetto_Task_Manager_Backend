...
public class Task extends PanacheMongoEntity {
    ...
    public List<String> getAssegnatari() { return assegnatari; }
    public void setAssegnatari(List<String> assegnatari) { this.assegnatari = assegnatari; }
    ...
    public ObjectId getIdProgetto() { return idProgetto; }
    public void setIdProgetto(ObjectId idProgetto) { this.idProgetto = idProgetto; }
}
